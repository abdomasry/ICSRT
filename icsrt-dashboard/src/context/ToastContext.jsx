...
const ToastContext = createContext({ show: () => {}, success: () => {}, error: () => {}, info: () => {}, warning: () => {} });
...
export function ToastProvider({ children }) {
  ...
  const showBase = useCallback((type, message, opts = {}) => {
    const id = idSeq++;
    ...
    const toast = { id, type, title, message: String(message || ''), duration };
  ...
  const api = useMemo(() => ({
    show: (message, opts) => showBase(opts?.type || 'info', message, opts),
    success: (message, opts) => showBase('success', message, opts),
    error: (message, opts) => showBase('error', message, opts),
    info: (message, opts) => showBase('info', message, opts),
    warning: (message, opts) => showBase('warning', message, opts),
    remove,
  }), [showBase, remove]);
