...
import { FaBars, FaTachometerAlt, FaUsers, FaFileAlt, FaClipboardList, FaEnvelope, FaCog, FaQuestionCircle, FaInfoCircle, FaEye, FaCalendarAlt, FaComments, FaShoppingCart, FaEnvelopeOpen, FaSignOutAlt, FaLock, FaTicketAlt, FaShareAlt, FaGift } from 'react-icons/fa';
...
const linkItems = [
  ...
  { name: 'events', icon: <FaCalendarAlt />, label: 'Events' },
  { name: 'newsletter-subscribers', icon: <FaEnvelopeOpen />, label: 'Newsletter' },
  { name: 'testimonials', icon: <FaComments />, label: 'Testimonials' },
