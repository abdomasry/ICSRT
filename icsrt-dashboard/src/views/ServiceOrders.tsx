...
const ServiceOrders = () => {
  ...
  const [generatedPurchaseLink, setGeneratedPurchaseLink] = useState<any>(null);
  ...
  const [lastNotifyResults, setLastNotifyResults] = useState<any>(null);
  // WhatsApp status
                      ...
                      {lastNotifyResults && (
                        <div className="mt-2 text-sm">
                          ...
                          <ul className="list-disc pl-5 space-y-0.5 text-gray-700">
                            {Object.entries(lastNotifyResults).map(([k,v]: [string, any]) => (
