...
router.post('/articles', optionalAuth, upload.single('document'), validate(createArticleSchema), articleController.createArticle);
...
router.post('/news', optionalAuth, upload.single('document'), validate(createArticleSchema), articleController.createArticle);
...
router.post('/papers', optionalAuth, upload.single('document'), validate(createArticleSchema), articleController.createArticle);
