        ...
        setArticles([
          {
            ...
            image: "https://via.placeholder.com/400x250/3B82F6/FFFFFF?text=Research+Plan",
            date: "March 15, 2025",
            dateAr: "15 مارس 2025",
            readTime: "5 min read",
          ...
          },
          {
            ...
            image: "https://via.placeholder.com/400x250/10B981/FFFFFF?text=Research+Websites",
            date: "March 10, 2025",
            dateAr: "10 مارس 2025",
            readTime: "7 min read",
          ...
          },
          {
            ...
            image: "https://via.placeholder.com/400x250/8B5CF6/FFFFFF?text=Research+Paper",
            date: "March 5, 2025",
            dateAr: "5 مارس 2025",
            readTime: "8 min read",
                ...
                {list.map((article, index) => (
                  <div key={article._id || `${startIndex}-${index}` } className={`bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                    ...
                    <div className="h-48 overflow-hidden relative">
                      <img 
                        src={article.image || article.imageUrl || "https://via.placeholder.com/400x250/3B82F6/FFFFFF?text=Article"} 
                        alt={isRTL ? article.titleAr || article.title : article.title}
                        className="w-full h-full object-cover transition-transform hover:scale-105"
                        onError={(e) => {
                          e.target.src = "https://via.placeholder.com/400x250/3B82F6/FFFFFF?text=Article";
                        }}
                      />
                      {article.category && (
