...
// Comprehensive country codes list (module-level constant to prevent GC allocations on render)
const COUNTRIES = [
  ...
  { code: '+387', country: 'Bosnia and Herzegovina', flag: '🇧🇦', nameAr: 'البوسنة والهرسك' },
  ...
  { code: '+236', country: 'Central African Republic', flag: '🇨🇫', nameAr: 'جمهورية أفريقيا الوسطى' },
  ...
  { code: '+420', country: 'Czech Republic', flag: '🇨🇿', nameAr: 'جمهورية التشيك' },
  ...
  { code: '+852', country: 'Hong Kong', flag: '🇭🇰', nameAr: 'هونغ كونغ' },
  ...
  { code: '+960', country: 'Maldives', flag: '🇲🇻', nameAr: 'جزر المالديف' },
  ...
  { code: '+850', country: 'North Korea', flag: '🇰🇵', nameAr: 'كوريا الشمالية' },
  { code: '+389', country: 'North Macedonia', flag: '🇲🇰', nameAr: 'مقدونيا الشمالية' },
  { code: '+47', country: 'Norway', flag: '🇳🇴', nameAr: 'النرويج' },
  { code: '+968', country: 'Oman', flag: '🇴🇲', nameAr: 'عمان' },
  ...
  { code: '+966', country: 'Saudi Arabia', flag: '🇸🇦', nameAr: 'المملكة العربية السعودية' },
  ...
  { code: '+886', country: 'Taiwan', flag: '🇹🇼', nameAr: 'تايوان' },
  ...
  { code: '+971', country: 'United Arab Emirates', flag: '🇦🇪', nameAr: 'الإمارات العربية المتحدة' },
