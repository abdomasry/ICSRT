        ...
        <div className={`absolute bottom-16 ${isRTL ? 'left-0' : 'right-0'} mb-4 space-y-3 w-64 z-[9999]`}>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs opacity-90">+20 123 456 7890</div>
            </div>
          </button>
          ...
          <button
            onClick={() => {
              window.open('https://wa.me/201234567890?text=Hello, I need help with academic services');
              setIsOpen(false);
            }}
            className="flex items-center w-full bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-xl shadow-lg transform hover:scale-105 cursor-pointer transition-all duration-200"
          >
          ...
          <button
            onClick={() => {
              window.open('mailto:contact@icsrt.org?subject=Academic Services Inquiry');
              setIsOpen(false);
            }}
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs opacity-90">contact@icsrt.org</div>
            </div>
          </button>
